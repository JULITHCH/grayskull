...
steps:
  ...
  implement the game exactly as planned, deviate only if the plan is impossible and say so: think=off temp=0.7 require=canvastest mcp=on
...
-> implement the game exactly as planned, deviate only if the plan is impossible and say so
